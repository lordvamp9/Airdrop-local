...
Private and glossy P2P file sharing for the web.

## Features
- Direct P2P file sharing using WebRTC.
...
## Deployment
This project is designed to be hosted on GitHub Pages or Netlify.
1. Upload `index.html` and `retro_liquid_glass_bg.png` to your repository.
